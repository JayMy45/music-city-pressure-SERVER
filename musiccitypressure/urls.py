...
from mcpressureapi.views import register_user, login_user, AppointmentView, ServiceTypeView, CustomerView, EmployeeView, EquipmentView, ProgressView
...
router.register(r'progressions', EquipmentView, 'progress')
