# Generated by Django 4.1.3 on 2023-02-05 07:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mcpressureapi.city')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='technician', to='mcpressureapi.employee')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mcpressureapi.customer')),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mcpressureapi.location')),
            ],
        ),
        migrations.AddField(
            model_name='customer',
            name='location',
            field=models.ManyToManyField(blank=True, through='mcpressureapi.CustomerLocation', to='mcpressureapi.location'),
        ),
        migrations.AddField(
            model_name='customer',
            name='user',
        ...
        migrations.AddField(
            model_name='appointments',
            name='employee',
            field=models.ManyToManyField(blank=True, related_name='employee', through='mcpressureapi.EmployeeAppointment', to='mcpressureapi.employee'),
        ),
        migrations.AddField(
            model_name='appointments',
            name='progress',
