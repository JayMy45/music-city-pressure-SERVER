...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CustomerConfirmAppointment',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('appointment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='confirmed', to='mcpressureapi.appointments')),
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='confirmed', to='mcpressureapi.customer')),
            ],
        ),
        migrations.AddField(
            model_name='appointments',
            name='confirm',
            field=models.ManyToManyField(blank=True, through='mcpressureapi.CustomerConfirmAppointment', to='mcpressureapi.customer'),
        ),
        migrations.AddField(
            model_name='appointments',
            name='customer',
